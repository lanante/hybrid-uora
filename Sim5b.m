...
for a=1:length(N_STA_Array)
    ...
    Pn=-94;
    S0=50;
    [e1_Tput(a) e1_Efficiency(a) ready_tau e1_p e1_b_idle e1_B e1_Latency(a) nTF tTF]=randomaccess_nfb11(EOCWminS(a),EOCWmaxS(a),n,r,200,U,5,20,tpdf,k,RSSI,Ldb,Drs,Pn,S0);
    ...
    for c=1:length(EOCWmaxArray)
        for d=c:length(EOCWminArray)
            e=e+1;
                ...
                [ea_Tput(a,e) ea_Efficiency(a,e) ready_tau e1_p e1_b_idle e1_B ea_Latency(a,e) nTF tTF]=randomaccess_nfb11(EOCWminArray(d),EOCWmaxArray(c),n,r,200,U,5,5,tpdf,k,RSSI,Ldb,Drs,Pn,S0);
...
figure(2)
plot(N_STA_Array,e1_Latency,'k-o','LineWidth',2);hold on
plot(N_STA_Array,ea_Latency,'k*');
